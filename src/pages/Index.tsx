...
const Index = () => {
  ...
  const aboutTranslations = {
    ...
    ta: {
      role: "உருவாக்குநர்",
      p1: "வணக்கம், நான் நிதீஷ். இந்த கேம்பஸ் நேவிகேட்டர் செயலியை உருவாக்குவது மிகவும் சுவாரஸ்யமாக இருந்தது. இது எப்படி வேலை செய்கிறது என்பதைப் பற்றி மேலும் அறிய விரும்பினால், கீழே உள்ள GitHub இணைப்பைப் பாருங்கள் - நான் திறந்த மூலக் கற்றலை (open-source learning) ஆழமாக நம்புகிறேன்.",
      ...
      attribution: "நிதீஷ், மேலும் அறிய"
    },
    hi: {
