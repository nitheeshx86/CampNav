...
const Index = () => {
  ...
  const aboutTranslations = {
    ...
    ta: {
      ...
      p3: "இந்த மதிப்புமிக்க வாய்ப்பை வழங்கிய விஐடி சென்னை வளாகத்தின் சர்வதேச உறவுகள் துறையின் உதவி இயக்குனர் முனைவர் ரீனா அவர்களுக்கு என் ஆழ்ந்த நன்றியை மரியாதையுடன் தெரிவித்துக் கொள்கிறேன்.",
